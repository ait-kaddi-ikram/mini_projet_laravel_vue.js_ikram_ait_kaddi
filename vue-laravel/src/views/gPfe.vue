     ...
     <navbarAdmin></navbarAdmin>
      ...
      <router-view />
          ...
          <div class="col-md-6 offset-md-3">
              <h2 class="display-4 text-center met-5">Ajouter Pfe</h2>
                         <div class="form-groupe">
                      <label for="">Sujet</label>
            <input type="text"  v-model="object.sujet" class="form-control" />
          </div>
                        <div class="form-groupe">
                      <label for="">La date de PFE</label>
            <input type="text"  v-model="object.date" class="form-control" placeholder="Ex:(Année-Mois-Jour)"/>
          </div>
                 <div class="form-groupe">
                      <label for="email">CNE de l'étudiant</label>
            <input type="text"  v-model="object.cne" class="form-control" />
          </div>
                  <div class="form-groupe">
                      <label for="Nom">Nom de professeur</label>
            <input type="text"  v-model="object.nom" class="form-control" />
          </div>
                    <div class="form-groupe">
                      <label for="Nom">Prénom de professeur</label>
            ...
            <br>
            <span v-show="added" style="color:red;">le pfe a été ajouté avec succés</span>
            <br>
          <br>
  ...
  components:{
   ...
   methods:{
     add(){
       ...
       axios.post('http://127.0.0.1:8000/api/pfeStore',this.object)
            .then(response =>{console.log(response);  
               console.log('perform Add pfe');
              this.added = true;
            }).catch(err => {
