<template>
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark row align-items-start">
        <div class="col-5">
    ...
    <div class="">
      ...
      <ul class="navbar-nav ml-auto" >
        ...
        <li class="nav-item" v-if="!loggedIn">
          <router-link class="btn btn-primary my-1 btn-block" to="/Login">se connecter</router-link>
        </li>
        <li class="nav-item" v-if="!loggedIn">
          <router-link
            class="btn btn-success my-1 ml-1 btn-block"
            ...
            tabindex="-1"
            aria-disabled="true"
          >creer compte admin</router-link>
        </li>
  ...
  data(){
    return {
     ...
     computed : {
         ...
         prof(){
          return this.$store.getters.get_prof;
       }
     },
